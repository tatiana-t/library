...
class TagList extends PureComponent<Props, State> {
  ...
  setListToState = (checkedList?: any) => {
    const { list } = this.props;

    const listToState = list.map((item: any) => ({
      id: item,
      text: item,
  ...
  setActive = (list: any, id: any) => {
    if (list) {
      const isActiveItem = list.find((tag: any) => tag.id === id);
